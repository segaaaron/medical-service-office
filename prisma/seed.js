...
Agenda tu consulta de valoración sin costo para conocer tu caso.`,
  ...
  const appointments = [
    {
      patientName:   'Paciente Demo 1',
      patientPhone:  '+10000000001',
      patientEmail:  'demo1@test.invalid',
      treatmentId:   cleaningTreatment.id,
      notes:         'Cita de prueba — confirmada.',
      status:        'CONFIRMED',
      scheduledAt:   new Date('2026-04-05T10:00:00Z'),
    },
    {
      patientName:   'Paciente Demo 2',
      patientPhone:  '+10000000002',
      patientEmail:  'demo2@test.invalid',
      treatmentId:   whiteningTreatment.id,
      notes:         'Cita de prueba — pendiente.',
      status:        'PENDING',
      scheduledAt:   new Date('2026-04-08T12:00:00Z'),
    },
    {
      patientName:   'Paciente Demo 3',
      patientPhone:  '+10000000003',
      patientEmail:  null,
      treatmentId:   cleaningTreatment.id,
      notes:         'Cita de prueba — sin email.',
      status:        'PENDING',
      scheduledAt:   new Date('2026-04-10T09:00:00Z'),
    },
    {
      patientName:   'Paciente Demo 4',
      patientPhone:  '+10000000004',
      patientEmail:  'demo4@test.invalid',
      treatmentId:   cleaningTreatment.id,
      notes:         null,
      status:        'COMPLETED',
